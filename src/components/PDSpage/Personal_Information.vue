...
<div class="row">
                  ...
                  <div class="col">
                    <div class="form-title-container">
                      <div class="text-h5 text-bold q-px-sm flex items-center q-gutter-x-sm">Employee's Name <q-badge>Outsider</q-badge></div>
                    </div>
                ...
                <q-separator class="q-my-md"/>
                <div>
                  <div class="text-h5 text-bold q-px-sm flex items-center q-gutter-x-sm">Permanent Address <q-badge>Same with Residential Address</q-badge></div>
                </div>
