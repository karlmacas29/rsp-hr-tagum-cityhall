    ...
    <q-card class="qualification-modal" style="width: 1200px; max-width: 95vw">
                ...
                <div class="col-6">
                  ...
                  <q-list dense bordered>
                    <q-item v-for="(qual, index) in qualifications" :key="index">
                      ...
                      <q-item-section side>
                        <q-icon
                          :name="qual.met ? 'check' : 'close'"
                          :color="qual.met ? 'positive' : 'negative'"
                        />
                      </q-item-section>
                    </q-item>
                  </q-list>
      ...
      <q-card-actions align="right" class="q-px-md q-py-md">
        ...
        <template v-else>
          ...
          <q-btn
            :label="applicationStatus === 'Qualified' ? 'Mark Unqualified' : 'Mark Qualified'"
            :color="applicationStatus === 'Qualified' ? 'negative' : 'positive'"
